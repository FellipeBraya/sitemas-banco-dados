...
-- ==========================================
-- 🏠 ATIVIDADE 2 — NORMALIZAÇÃO DO ENDEREÇO
-- ==========================================
...
-- =============================================
-- 🩺 ATIVIDADE 3 — NORMALIZAÇÃO DA ESPECIALIDADE
-- =============================================
...
-- =====================================================
-- 🔢 ATIVIDADE 4 — LIMPEZA E PADRONIZAÇÃO DE CPF E TELEFONE
-- =====================================================
...
-- ==========================================
-- 📧 ATIVIDADE 5 — EMAIL: UNIQUE E CHECK
-- ==========================================
...
-- Médicos sem consultas (NOT EXISTS)
SELECT p.nome, m.crm
FROM medico m
JOIN pessoa p ON m.pessoa_id = p.id
WHERE NOT EXISTS (
...
-- =======================================================
-- 🔒 ATIVIDADE 8 — CONSTRAINTS NOT NULL E UNIQUE + TESTES
-- =======================================================

-- 1️⃣ Tornar colunas obrigatórias e únicas onde faz sentido
...
-- 2️⃣ TESTES DE VERIFICAÇÃO DAS RESTRIÇÕES UNIQUE
-- (os comandos abaixo DEVEM gerar erro de violação de chave única)

-- Teste 1: tentar duplicar o número do cartão de um paciente
INSERT INTO paciente (pessoa_id, numero_cartao, data_cadastro)
VALUES (100, 'PLANO-A-0001', '2025-10-28');  -- já existe

-- Teste 2: tentar duplicar o CRM de um médico
INSERT INTO medico (pessoa_id, crm, especialidade_id)
VALUES (100, 'CRM-1001', 1);  -- já existe

-- Teste 3: tentar duplicar e-mail de uma pessoa existente
INSERT INTO pessoa (nome, cpf, data_nascimento, telefone, email, logradouro, numero)
VALUES ('Teste Duplicado', '99999999999', '1990-01-01', '11988887777', 'joao.silva@example.com', 'Rua Z', '999');

-- ===================================
-- ✅ PRÉ-CHECAGENS DE INTEGRIDADE
-- ===================================
